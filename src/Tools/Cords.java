...
/**
 * this class represents a simple coordinate conversion between lat/lon (sphere) to Cartesian,
 * allowing to convert lat/lon coordinations to x,y (pixels / meters).
 * Moreover it allows performing computations in lat / lon in terms of direction (angle),
 * distance (meter).
 * Note: this code was written for IoT devices - it is in C-like java style. 
 * 
